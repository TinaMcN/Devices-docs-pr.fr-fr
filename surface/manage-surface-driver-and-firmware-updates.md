...
- [Gérer les mises à jour de pilotes Surface dans Configuration Manager](https://docs.microsoft.com/surface/manage-surface-driver-updates-configuration-manager)
...
2. Sélectionnez le nom du fichier. msi qui correspond au modèle de surface et à la version de Windows. Le nom du fichier. msi inclut le numéro de build Windows minimal pris en charge requis pour installer les pilotes et le microprogramme. Par exemple, reportez-vous à la figure suivante. Pour mettre à jour un plan de surface 2 qui dispose de la version 18362 de Windows 10, sélectionnez **SurfaceBook2_Win10_18362_19.101.13994.msi.** Pour un classeur surface 2 qui dispose de la version 16299 de Windows 10, sélectionnez **SurfaceBook2_Win10_16299_1803509_3.msi**.
...
Depuis le 2019 août, les fichiers. msi utilisent la Convention d’affectation de noms suivante:
...
Les fichiers. msi hérités (fichiers générés avant le 2019 août) ont suivi la même formule d’appellation globale mais ont utilisé une méthode différente pour dériver le numéro de version.
